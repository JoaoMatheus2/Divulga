...
import { getVideosByPackageId, updateVideoStatus } from '@/services/dataService';
...
const VideoManager: React.FC<VideoManagerProps> = ({ package: pkg, onClose }) => {
  ...
  const handleStatusUpdate = async (videoId: string, newStatus: Video['status']) => {
    setUpdating(videoId);
            ...
            <Card key={video.id}>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="text-xs text-gray-500">
                  Atualizado em: {video.updatedAt.toLocaleDateString()}
                </div>
